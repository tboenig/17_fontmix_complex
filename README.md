<div>
   <h1 id="title">17_fontmix_complex</h1>
   <p id="paragraph">Ground Truth with a collection of documents with the following characteristics: 
fonts blackletter and antiqua, partly two-columned, initials, partly two-columned, marginal notes, tabular-like layout, hand-written additions</p>
   <h2>Metadata</h2>
   <dl class="grid">
